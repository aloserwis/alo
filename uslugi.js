...
const serviceCopy = {
    ...
    EN: {
        ...
        servicesKicker: 'DEVICE REPAIR', servicesTitle: 'We repair the devices you use every day', servicesLead: 'From cracked glass to advanced motherboard repair — first we diagnose, then provide a clear quote.',
        tabletLabel: 'TABLET SERVICE', tabletTitle: 'Complete tablet repair', tabletLead: 'We restore screens, electronics and software regardless of the device brand.', tabletOne: 'Display, glass and digitizer replacement or repair', tabletTwo: 'Touch panel and display fault repair', tabletThree: 'Motherboard repair and charging port replacement', tabletFour: 'Repair after impact or liquid damage', tabletFive: 'Camera, sound, microphone and speaker repair', tabletSix: 'Software, cleaning and battery replacement',
        phoneLabel: 'PHONE SERVICE', phoneTitle: 'Professional phone repair', phoneLead: 'Fast mechanical, electronic and software repairs at a professional service workstation.', phoneOne: 'Glass replacement or complete display module replacement', phoneTwo: 'Motherboard and charging port repair', phoneThree: 'GSM, Wi-Fi and Bluetooth signal repair', phoneFour: 'Simlock removal and software repair', phoneFive: 'Camera, microphone and audio repair', phoneSix: 'Cleaning, liquid-damage repair and battery replacement', askQuote: 'Ask for a free quote',
        laptopTitle: 'Laptop and computer service', laptopLead: 'We diagnose hardware and system faults, clean cooling systems and restore device performance.', laptopOne: 'Motherboards', laptopTwo: 'Cooling', laptopThree: 'Drives and data', laptopFour: 'System and software',
    ...
    VN: {
        ...
        servicesKicker: 'SỬA CHỮA THIẾT BỊ', servicesTitle: 'Sửa chữa các thiết bị bạn sử dụng hằng ngày', servicesLead: 'Từ vỡ mặt kính đến sửa chữa mainboard chuyên sâu — chúng tôi chẩn đoán trước và báo giá rõ ràng sau.',
        tabletLabel: 'SỬA TABLET', tabletTitle: 'Sửa chữa máy tính bảng toàn diện', tabletLead: 'Khôi phục màn hình, phần cứng và phần mềm cho nhiều thương hiệu thiết bị.', tabletOne: 'Thay hoặc sửa màn hình, mặt kính và cảm ứng digitizer', tabletTwo: 'Sửa cảm ứng và các lỗi hiển thị hình ảnh', tabletThree: 'Sửa mainboard và thay cổng sạc', tabletFour: 'Khắc phục thiết bị rơi vỡ hoặc vào nước', tabletFive: 'Sửa camera, âm thanh, micro và loa', tabletSix: 'Phần mềm, vệ sinh và thay pin',
        phoneLabel: 'SỬA ĐIỆN THOẠI', phoneTitle: 'Sửa chữa điện thoại chuyên nghiệp', phoneLead: 'Xử lý nhanh các lỗi cơ khí, điện tử và phần mềm tại bàn kỹ thuật chuyên nghiệp.', phoneOne: 'Ép kính hoặc thay toàn bộ cụm màn hình', phoneTwo: 'Sửa mainboard và cổng sạc', phoneThree: 'Sửa lỗi sóng GSM, Wi-Fi và Bluetooth', phoneFour: 'Mở khóa Simlock và sửa phần mềm', phoneFive: 'Sửa camera, micro và hệ thống âm thanh', phoneSix: 'Vệ sinh, xử lý vào nước và thay pin', askQuote: 'Yêu cầu báo giá miễn phí',
        laptopTitle: 'Sửa laptop và máy tính', laptopLead: 'Chẩn đoán lỗi phần cứng và hệ thống, vệ sinh tản nhiệt và khôi phục hiệu năng thiết bị.', laptopOne: 'Mainboard', laptopTwo: 'Tản nhiệt', laptopThree: 'Ổ cứng và dữ liệu', laptopFour: 'Hệ điều hành và phần mềm',
